...
\begin{document}
	...
	Die Integration dieser Mathematik-Bausteine in den regulären Unterricht schafft eine hohe Relevanz, fördert die Medienkritik und bereitet Jugendliche auf die quantitative Durchdringung von KI-Phänomenen vor – eine Schlüsselkompetenz des 21. Jahrhunderts.
	
	\section{Fazit}
	
	KI-Systeme im Online-Dating bergen für Jugendliche erhebliche Gefahren, die von emotionaler Manipulation über Datenschutzverletzungen bis hin zu realen Suizidfällen reichen. Angesichts der steigenden Nutzung – 91 Prozent der Jugendlichen zwischen 12 und 19 Jahren nutzen KI-Anwendungen \cite{JIM2025} – ist eine konsequente Sensibilisierung dringend erforderlich. Die Förderung von Medienkompetenz durch Gespräche, schulische Aufklärung und psychologische Begleitung kann dazu beitragen, Jugendliche zu schützen. Darüber hinaus können erste Programmierkenntnisse in Python Jugendlichen helfen, KI-gestützte Täuschungen zu durchschauen und sogar eigene kleine Schutzmechanismen zu entwickeln. Wer fortgeschrittene Techniken wie Regex, API-Abfragen oder einfaches Machine Learning erlernt, baut sich einen echten Werkzeugkasten für digitale Selbstverteidigung. Nicht zuletzt bietet der Mathematikunterricht hervorragende Möglichkeiten, Bot-Erkennung statistisch und algorithmisch zu fundieren – von deskriptiver Statistik über Wahrscheinlichkeitsrechnung bis hin zu linearer Algebra. Gleichzeitig müssen gesetzliche Rahmenbedingungen geschaffen und technische Schutzmaßnahmen verbessert werden, um die Sicherheit junger Menschen im digitalen Raum zu gewährleisten.
	...
	\begin{thebibliography}{99}
		...
		% Neue Quellen für den Mathematik-Abschnitt
