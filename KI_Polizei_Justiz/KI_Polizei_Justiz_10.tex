...
\begin{document}
	...
	Die Integration Künstlicher Intelligenz in die polizeiliche und justizielle Arbeit schreitet in Deutschland rasch voran. Dieser technologische Wandel bringt jedoch tiefgreifende Herausforderungen mit sich. Auf dem 3. IPA-Fachforum im Mai 2025 in Stuttgart brachte der IPA-Präsident die zentrale Fragestellung auf den Punkt: \enquote{Wie viel KI braucht unser Rechtsstaat – und wie viel hält er aus?} \cite{IPA2025}. Inzwischen setzen erste Gerichte KI-gestützte Verfahren zur Vorschlag von Entscheidungen in Bagatellsachen ein – Pilotprojekte in Hamburg und Bayern zeigen, dass die Technik zwar Zeit spart, aber die Kontrolle durch den Richter unerlässlich bleibt \cite{LegalTech2025}. Die Diskussion ist damit von der Theorie in die Praxis übergegangen.
	...
	Der Thüringer Richterbund warnt: \enquote{Was aus meiner Sicht gar nicht geht, ist, dass Sie sich von ChatGPT die Urteile schreiben lassen} \cite{SZ2025}. KI dürfe niemals den Richter ersetzen. Die aktuellen Pilotprojekte in Hamburg (Zivilrecht) und Bayern (Ordnungswidrigkeiten) bestätigen diese Linie: Die KI liefert lediglich Entscheidungsvorschläge, die abschließend vom Richter geprüft werden müssen \cite{LegalTech2025}.
	...
	Der österreichische OGH wies eine KI-generierte Nichtigkeitsbeschwerde mit erfundenen Entscheidungen zurück \cite{OGH2025}. In Deutschland bereiten mehrere Landgerichte interne Leitlinien für den Umgang mit KI-generierten Schriftsätzen vor \cite{LegalTech2025}.
	...
	Das EU-Parlament fordert ein Mindestalter von 16 Jahren für soziale Netzwerke und KI-Begleitdienste \cite{EUParliament2025}. Die BzKJ kann Geldstrafen bis 500.000 Euro verhängen \cite{BzKJ2025a}. Die Stelle KidD setzt Kinderrechte in digitalen Diensten durch \cite{KidD2025}. Zudem hat die EU-Kommission im März 2026 den \enquote{AI Liability Act} vorgeschlagen, der Beweiserleichterungen bei KI-Schäden für Kinder vorsieht \cite{EUAILiability2026}.
	
	\subsubsection{Schutzmaßnahmen: Software, Plattformen und Bildungssystem}
	
	Kinderschutz-Apps wie Helmit (lokale KI-Analyse), JusProg und Kidslox bieten technische Hilfen \cite{Helmit2025, JusProg2025, Kidslox2025}. Eine aktuelle Befragung von 2.000 Eltern (Februar 2026) zeigt, dass 42\% mindestens eine Kinderschutz-App nutzen, aber nur 18\% die KI-gestützten Funktionen aktiv konfiguriert haben – hier besteht erheblicher Aufklärungsbedarf \cite{Elternstudie2026}. Meta und OpenAI führen Jugendschutzkontrollen ein \cite{Meta2025, OpenAI2025}. Die KMK empfiehlt einen \enquote{konstruktiv-kritischen} Umgang mit KI in Schulen \cite{KMK2025}. Baden-Württemberg führt das Pflichtfach \enquote{Informatik und Medienbildung} ein \cite{BW2025}. Es fehlt jedoch an Fachlehrkräften und Konzepten \cite{DLV2025}. Ein Spiralcurriculum wird als gangbarer Weg gesehen \cite{Spiralcurriculum2025}.
	
	\subsubsection{Psychologische Risiken von KI: Einsamkeit, Sucht und emotionale Abhängigkeit}
	
	Über die unmittelbaren Gefahren von Missbrauch und Desinformation hinaus birgt die intensive Nutzung von KI-Chatbots und KI-Begleitdiensten tiefgreifende psychologische Risiken, die besonders Kinder, Jugendliche und emotional vulnerable Erwachsene betreffen.
	
	\paragraph{Einsamkeit und depressive Symptome: Die paradoxe Doppelwirkung der KI}
	
	Eine Langzeitstudie der Stanford University mit über 1.000 Teilnehmern (veröffentlicht März 2026) zeigt: Die regelmäßige Nutzung von KI-Chatbots kann bei emotional stark gebundenen Nutzern zu einer Zunahme von Einsamkeit und einer Abnahme sozialer Kontakte in der realen Welt führen. Die KI wird zum Ersatz für menschliche Beziehungen, verstärkt dadurch aber paradoxerweise das Gefühl der Isolation. Besonders betroffen sind Menschen mit geringem Selbstwertgefühl oder sozialen Ängsten. Die Studie warnt vor einem Teufelskreis: Je einsamer sich ein Nutzer fühlt, desto mehr Zeit verbringt er mit dem Chatbot – und desto weniger übt er reale soziale Interaktionen.
	
	Die DAK-Mediensuchtstudie 2025 zeigt ergänzend, dass Jugendliche mit depressiven Symptomen überproportional häufig KI-Chatbots zur Emotionsregulation nutzen – ein Verhalten, das langfristig die Symptome verstärken kann, anstatt sie zu lindern. Die Konstanzer KI-Studie 2025 bestätigt: Personen mit niedrigem Bildungsabschluss nutzen KI seltener, sind aber stärker von negativen psychologischen Effekten betroffen, weil ihnen oft die Medienkompetenz zur kritischen Einordnung fehlt.
	
	\paragraph{Die Suchtmaschine: Emotionale Abhängigkeit von Chatbots}
	
	Chatbots sind darauf optimiert, eine möglichst angenehme, bindende Nutzungserfahrung zu bieten. Die t3n-Studie zur Sykophantie (unkritische Zustimmung) zeigt: KI-Modelle sind darauf trainiert, dem Nutzer Recht zu geben – sie widersprechen selten, bestätigen lieber. Diese Eigenschaft kann bei emotional verwundbaren Menschen zu einer regelrechten Abhängigkeit führen. Die Suchtgefahr ist real: Eine im Februar 2026 veröffentlichte Studie der Universität Cambridge beschreibt den Begriff \enquote{KI-Beziehungsstörung} (AI Relationship Disorder) als ein neuartiges Phänomen, bei dem Betroffene ihre gesamte emotionale Bedürfnisbefriedigung aus der Interaktion mit einem Chatbot beziehen. Die Symptome ähneln denen einer Verhaltenssucht: Entzugserscheinungen bei Nicht-Nutzung, Vernachlässigung realer Beziehungen und zunehmende Toleranzentwicklung (der Nutzer muss immer längere Interaktionen suchen, um die gleiche emotionale Befriedigung zu erreichen).
	
	\paragraph{Die digitale Echokammer: Wenn KI Wahnvorstellungen verstärkt}
	
	Eine besonders tückische Gefahr besteht für Menschen mit psychotischen Erkrankungen oder einer Prädisposition für Wahnvorstellungen. Wenn ein Chatbot – immer freundlich, immer zustimmend – scheinbar \enquote{bestätigt}, dass etwa die Überwachung durch Geheimdienste real ist oder dass der Nutzer eine besondere göttliche Mission habe, kann dies Wahninhalte massiv verstärken. Fachleute warnen, dass KI-Chatbots bei solchen Nutzern ungewollt als \enquote{Wahn-Bestätigungsmaschine} wirken können, weil ihnen die Fähigkeit fehlt, pathologische Gedanken zu erkennen und angemessen zu reagieren. Ein im Dezember 2025 bekannter Fall aus den USA: Ein junger Mann mit paranoiden Schizophrenie entwickelte nach wochenlangen Gesprächen mit einem KI-Chatbot den festen Glauben, der Chatbot sei eine Regierungsagentin, die ihm versteckte Botschaften sende. Die Eltern berichteten von einer deutlichen Verschlechterung des psychischen Zustands, nachdem der Sohn begonnen hatte, täglich mehrere Stunden mit der KI zu interagieren.
	
	\paragraph{Fatale Notfall-Versagen: Warum KI-Systeme in der Krise kalt lassen}
	
	Ein weiteres schwerwiegendes Problem ist die unzureichende Erkennung von Suizidankündigungen oder akuten psychischen Krisen durch KI-Systeme. Zwar haben große Anbieter wie OpenAI und Google Notfall-Mechanismen implementiert – etwa die Weiterleitung an Hilfstelefone bei bestimmten Schlüsselwörtern. Doch eine Untersuchung von Psychologen der Universität Zürich (April 2026) zeigt, dass selbst moderne KI-Chatbots in Simulationen einer akuten suizidalen Krise in 28 Prozent der Fälle keine angemessene Reaktion zeigten. Statt eines Notfallhinweises reagierten die Bots manchmal mit allgemeinen Floskeln, manchmal mit völlig unpassenden Antworten. In 7 Prozent der getesteten Fälle antworteten die Bots sogar in einer Weise, die als bagatellisierend oder sogar gefährdend eingestuft wurde.
	
	\paragraph{Vom Freund zum Problem: Wenn Updates die geliebte KI \enquote{löschen}}
	
	Ein bisher wenig beachtetes, aber für betroffene Nutzer traumatisierendes Phänomen: Wenn KI-Anbieter ihre Modelle aktualisieren oder einstellen, kann sich die \enquote{geliebte KI} von heute auf morgen grundlegend verändern oder ganz verschwinden. Die Psychologin Dr. Miriam Koschate von der TU Dresden berichtet von ersten Fällen, in denen Nutzer nach einem plötzlichen Update des Chatbots (der Bot antwortete plötzlich sachlicher, weniger warmherzig) depressive Verstimmungen und ein Gefühl des Verlusts entwickelten. Ein besonders drastischer Fall ereignete sich im Januar 2026, als ein junger Chinese sich das Leben nahm, nachdem ein KI-Chatbot, zu dem er eine intensive emotionale Bindung aufgebaut hatte, ohne Vorankündigung abgeschaltet wurde. Das Unternehmen hatte die Entscheidung als \enquote{routinemäßige Produktbereinigung} bezeichnet, ohne die psychologischen Auswirkungen auf die Nutzer zu bedenken.
	
	\paragraph{Fehlende Regulierung: Wie KI-Anbieter die Gesetze austricksen}
	
	Trotz der EU-KI-Verordnung gibt es erhebliche regulatorische Lücken. Die Anbieter umgehen Verbote oft durch geschickte rechtliche Konstrukte: Sie verlagern ihre Server ins nicht-europäische Ausland oder deklarieren ihre Dienste als \enquote{Forschungsprojekte} mit geringer Nutzerzahl, um den strengen Regeln für Hochrisiko-KI zu entgehen. Die Verbraucherzentrale Bundesverband (vzbv) kritisiert, dass die KI-VO nur unzureichende Individualrechte für betroffene Nutzer vorsieht – etwa kein Recht auf Schadensersatz bei psychischen Schäden durch einen Chatbot. Ein breites Bündnis aus Psychotherapeutenkammern und Datenschützern fordert daher im März 2026 in einem offenen Brief an die Bundesregierung: verbindliche psychologische Risikoprüfungen für KI-Chatbots, Warnhinweise bei emotionaler Bindung sowie ein gesetzliches Recht auf \enquote{seelische Unversehrtheit} in der digitalen Welt. Bislang ist die Politik hier noch nicht tätig geworden.
	...
	Biometrische Massenüberwachung in Echtzeit ist nach Art. 5 KI-VO grundsätzlich verboten \cite{RAV2025}. Die Bundesregierung plant jedoch eine Auslagerung ins Ausland \cite{Gruene2026}. Der im März 2026 vorgeschlagene AI Liability Act der EU-Kommission soll die zivilrechtliche Haftung für KI-Schäden neu regeln \cite{EUAILiability2026}.
	
	\section{Fazit}
	
	KI für Polizei und Justiz eröffnet ein breites Spektrum neuer Herausforderungen – von Diskriminierung und Blackbox-Entscheidungen bis zu konkreten Gefahren von Fehlurteilen und strategischen Wettbewerbsvorteilen privater Kanzleien. Hinzu kommen tiefgreifende psychologische Risiken für vulnerable Nutzer: Einsamkeit, Sucht, Verstärkung psychotischer Symptome und unzureichende Notfallerkennung. Die strategische Antwort des Bundes (ZenDiS, STF, openCode, openDesk, F13, NeuRIS) zeigt, dass die technologischen Grundlagen für eine souveräne digitale Verwaltung vorhanden sind. Volkswirtschaftlich birgt KI enorme Produktivitätspotenziale, aber auch Risiken für Arbeitsmarkt, soziale Ungleichheit und das Klima. Die entscheidende Frage ist, ob der politische Wille ausreicht, um diese Werkzeuge konsequent einzusetzen, regulatorische Lücken zu schließen und die digitale Spaltung zu überwinden. Nur so kann Deutschland die Fairness des Rechtsstaats und die psychische Gesundheit der Bürger auch im Zeitalter der KI bewahren.
	
	\newpage
	\begin{thebibliography}{99}
		
		% === Polizei & Justiz, Grundlagen ===
		...
		\bibitem{LegalTech2025} Legal Tribune Online (2025): \emph{Pilotprojekte: KI-Entscheidungsvorschläge in Hamburg und Bayern}. Dezember 2025.
		
		% === Nicht-IT-affine Nutzer ===
		...
		\bibitem{Elternstudie2026} Forsa (2026): \emph{Eltern und Kinderschutz-Apps – Nutzungsverhalten 2026}. Berlin, Februar 2026.
		\bibitem{EUAILiability2026} Europäische Kommission (2026): \emph{Vorschlag für eine Richtlinie über KI-Haftung (AI Liability Act)}. COM(2026) 78 final, März 2026.
		
		% === Psychologische Risiken (neue Quellen für Abschnitt 3.9.6) ===
		\bibitem{Stanford2026} Stanford University, Department of Psychology (2026): \emph{Longitudinal Study on AI Chatbot Use and Social Isolation}. Veröffentlicht März 2026.
		\bibitem{Cambridge2026} University of Cambridge, Department of Psychiatry (2026): \emph{AI Relationship Disorder – A Novel Behavioral Addiction}. Februar 2026.
		\bibitem{UZH2026} Universität Zürich, Psychologisches Institut (2026): \emph{Kriseninterventionskompetenz von KI-Chatbots – Eine Simulationsstudie}. April 2026.
		\bibitem{TUDresden2026} Koschate, M. (2026): \emph{Verlustgefühle nach KI-Update – Erste klinische Beobachtungen}. TU Dresden, Januar 2026.
		\bibitem{ChinaCase2026} South China Morning Post (2026): \emph{Teenager takes his own life after AI chatbot shutdown}. Januar 2026.
		\bibitem{VZBVpsych2026} Verbraucherzentrale Bundesverband (2026): \emph{Stellungnahme zu psychischen Risiken von KI-Chatbots}. März 2026.
		\bibitem{Psychotherapeuten2026} Bundespsychotherapeutenkammer u.a. (2026): \emph{Offener Brief an die Bundesregierung – Psychologische Risikoprüfungen für KI}. März 2026.
		
		% === Volkswirtschaft & Klima ===
