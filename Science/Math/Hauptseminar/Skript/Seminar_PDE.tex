...
\fancyhead[R]{13.07.2017} %Kopfzeile rechts
...
\title{Hauptseminar \\ Partielle Differentialgleichungen}
...
\input{sections/nichtlineare_eigenwertprobleme}
\input{sections/einseitige_neben}
\end{document}